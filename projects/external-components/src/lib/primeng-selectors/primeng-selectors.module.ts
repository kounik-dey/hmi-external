import { BirthdayComponent } from './components/Birthday--external/Birthday--external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        FileUploadComponent,
        TypeaheadComponent,
        NavMenuComponent, BirthdayComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        TypeaheadComponent, NavMenuComponent, BirthdayComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
