import { BirthdayWishesComponent } from './components/Birthday-wishes--external/Birthday-wishes--external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, BirthdayWishesComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, BirthdayWishesComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
