import { BirthdayGreetingsComponent } from './components/Birthday-Greetings-external/Birthday-Greetings-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        FileUploadComponent,
        TypeaheadComponent,
        NavMenuComponent, BirthdayGreetingsComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        TypeaheadComponent, NavMenuComponent, BirthdayGreetingsComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
