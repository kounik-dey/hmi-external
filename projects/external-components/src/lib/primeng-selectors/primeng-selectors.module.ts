import { ShoppingComponent } from './components/Shopping-external/Shopping-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, ShoppingComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, ShoppingComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
