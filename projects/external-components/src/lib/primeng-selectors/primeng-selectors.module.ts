import { tikTakComponent } from './components/tik-Tak--external/tik-Tak--external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, tikTakComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, tikTakComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
